...
namespace ppb_gen::demo_comp3::Enums
{
    ...
    using schema = ::ppb::auto_schema<
        ...
        ::ppb::enumerated<F::cs, ::ppb_gen::demo_comp3::Color, ::ppb::field_semantics::always_lexn>>;
...
namespace ppb_gen::demo_comp3::Fixeds
{
    ...
    using schema = ::ppb::auto_schema<
        ...
        ::ppb::fixed32<F::f32s, ::ppb::field_semantics::always_lexn>,
        // ppb::on_bulk<F::s64s>(range_fn, elem_fn)
        ::ppb::packed_sfixed64<F::s64s>,
        ::ppb::sfixed64<F::s64s, ::ppb::field_semantics::always_lexn>,
        // ppb::on_bulk<F::fls>(range_fn, elem_fn)
        ::ppb::packed_f32<F::fls>,
        ::ppb::f32<F::fls, ::ppb::field_semantics::always_lexn>,
        // ppb::on_bulk<F::ds>(range_fn, elem_fn)
        ::ppb::packed_f64<F::ds>,
        ::ppb::f64<F::ds, ::ppb::field_semantics::always_lexn>>;
