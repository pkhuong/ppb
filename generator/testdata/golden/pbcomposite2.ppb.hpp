...
namespace ppb_gen::demo_comp2::UEnums
{
    ...
    using schema = ::ppb::auto_schema<
        ...
        ::ppb::packed_enumerated<F::cs, ::ppb_gen::demo_comp2::Color, ::ppb::field_semantics::error>>;
...
namespace ppb_gen::demo_comp2::UFixeds
{
    ...
    using schema = ::ppb::auto_schema<
        ...
        ::ppb::packed_fixed32<F::f32s, ::ppb::field_semantics::error>,
        // ppb::on_each<F::ds>(...)
        ::ppb::unpacked_f64<F::ds>,
        ::ppb::packed_f64<F::ds, ::ppb::field_semantics::error>>;
